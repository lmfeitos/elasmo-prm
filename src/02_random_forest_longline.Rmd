...
ggsave(plot1, file = paste0("fig2.pdf"), path = here::here("figs", "poster"), height = 12, width = 18)

plot <- p2 + v2 / q2

ggsave(plot, file = paste0("fig2b.pdf"), path = here::here("figs", "poster"), height = 12, width = 22)
```
