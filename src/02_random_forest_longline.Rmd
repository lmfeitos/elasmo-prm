...
avm_recipe <- recipe(mortality_prop ~ reproductive_mode + median_depth + max_size_cm + habitat + ventilation_method + ac + eo, data = avm_train) %>%
  step_normalize(all_numeric_predictors())

prm_recipe <- recipe(mortality_prop ~ reproductive_mode + max_size_cm + habitat + ventilation_method, data = elasmo_prm) %>%
  step_normalize(all_numeric_predictors())
```
