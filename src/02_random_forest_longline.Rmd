...
v1 <- avm_fit %>%
  ...
  scale_x_discrete(labels = c("Ventilation Method", "Habitat", "Reproductive Mode", "Maximum Size (cm)", "Median Depth (m)", "Hypoxia Vulnerability"))
v1
...
v2 <- prm_fit %>%
  ...
  scale_x_discrete(labels = c("Ventilation Method", "Reproductive Mode", "Median Depth", "Maximum Size (cm)", "Hypoxia Vulnerability"))
v2
```
