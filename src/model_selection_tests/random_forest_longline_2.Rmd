...
avm_recipe <- recipe(mortality_prop ~ median_depth + max_size_cm + habitat_associated + reproductive_mode, data = avm_train) %>%
  step_normalize(all_numeric_predictors())

prm_recipe <- recipe(mortality_prop ~ median_depth + max_size_cm + habitat_associated + reproductive_mode, data = elasmo_prm) %>%
  step_normalize(all_numeric_predictors())
```
