...
avm_folds <- vfold_cv(elasmo_avm, repeats = 10, v = 3, strata = family)
...
avm_recipe <- recipe(mortality_prop ~ ventilation_method + median_depth + max_size_cm + reproductive_mode, data = elasmo_avm) %>%
