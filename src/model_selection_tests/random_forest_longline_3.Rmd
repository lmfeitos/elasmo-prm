...
avm_recipe <- recipe(mortality_prop ~ median_depth + max_size_cm + reproductive_mode + eo_new + ac_new, data = avm_train) %>%
  step_normalize(all_numeric_predictors())

prm_recipe <- recipe(mortality_prop ~ median_depth + max_size_cm + reproductive_mode, data = elasmo_prm) %>%
  step_normalize(all_numeric_predictors())
```
