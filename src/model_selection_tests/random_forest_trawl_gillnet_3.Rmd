...
trawl_recipe <- recipe(mortality_prop ~ median_depth + max_size_cm + habitat_associated, data = elasmo_trawl) %>%
  step_normalize(all_numeric_predictors())

gillnet_recipe <- recipe(mortality_prop ~ median_depth + max_size_cm + habitat_associated, data = elasmo_gillnet) %>%
  step_normalize(all_numeric_predictors())
```
