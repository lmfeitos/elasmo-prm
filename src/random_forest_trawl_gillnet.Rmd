...
ggsave(plot1, file = paste0("trawl_val.pdf"), path = here::here("figs"), height = 10, width = 15)
```
...
ggsave(plot2, file = paste0("gill_val.pdf"), path = here::here("figs"), height = 10, width = 15)
```
