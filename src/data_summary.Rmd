...
# reproductive mode
rep_mode_median <- predictions_full %>% 
...
# ventilation method
vent_method_median <- predictions_full %>% 
  group_by(estimate_type, ventilation_method) %>% 
  summarise(median_mort = median(mortality_prop, na.rm = TRUE),
            var_mort = var(mortality_prop, na.rm = TRUE))

# habitat associated
habitat_median <- predictions_full %>% 
...
predictions_full_gear <- predictions_full %>% 
