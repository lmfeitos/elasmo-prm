...
basedir <- file.path("G:/Meu Drive/PRM Review/data/")
ramdir <- file.path(basedir, "RAMLDB v4.64", "Excel")

ram_ts_val <- read_excel(file.path(basedir, "ram", "Excel", "RAMLDB v4.65 (assessment data only).xlsx"),
                                sheet = "timeseries_values_views")

ram_stock <- read_excel(file.path(basedir, "ram", "Excel", "RAMLDB v4.65 (assessment data only).xlsx"),
                                sheet = "stock")
