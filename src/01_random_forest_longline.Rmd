...
v2 <- prm_fit %>%
  ...
  scale_x_discrete(labels = c("Maximum Size (cm)", "Median Depth (m)", "Associated Habitat", "Reproductive Mode"))
v2
```
...
ggsave(plot1, file = paste0("longline_val.pdf"), path = here::here("figs"), height = 10, width = 15)
```
