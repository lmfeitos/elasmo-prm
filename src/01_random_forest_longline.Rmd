...
v2 <- prm_fit %>%
  ...
  scale_x_discrete(labels = c("Ventilation Method", "Reproductive Mode", "Maximum Size (cm)", "Associated Habitat"))
v2
```
...
ggsave(plot1, file = paste0("fig2.pdf"), path = here::here("figs"), height = 12, width = 15)
```
