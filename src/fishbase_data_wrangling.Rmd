...
shark_saup_join <- saup_spp %>% 
  ...
  left_join(int_growth, by = "scientific_name") %>% 
  select(-c(habitat, value, r_value, reference, observations, areas, pop_growth_rate_measure, spec_code, genus, species, species_ref_no, fam_code, longevity_wild)) %>% 
