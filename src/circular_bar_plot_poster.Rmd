...
```{r}
# label_data_m = label_data_m %>% 
#   mutate(scientific_name = case_when(
#     scientific_name == "Great hammerhead" ~ "Great hammerhead",
#     scientific_name == "Scalloped bonnethead" ~ "Scalloped bonnethead",
#     scientific_name == "Angelshark" ~ "Angelshark",
#     scientific_name == "Scalloped hammerhead" ~ "Scalloped hammerhead",
#     scientific_name == "Thresher" ~ "Thresher Shark",
#     scientific_name == "Picked dogfish" ~ "Picked dogfish",
#     scientific_name == "Whitetip reef shark" ~ "Whitetip reef shark",
#     scientific_name == "Lemon shark" ~ "Lemon shark",
#     scientific_name == "Bull shark" ~ "Bull shark",
#     scientific_name == "Silky shark" ~ "Silky shark",
#     scientific_name == "Dusky catshark" ~ "Dusky catshark",
#     scientific_name == "Tawny nurse shark" ~ "Tawny nurse shark",
#     scientific_name == "Daggernose shark" ~ "Daggernose shark",
#     scientific_name == "Spinner shark" ~ "Spinner shark",
#     scientific_name == "Pacific sharpnose shark" ~ "Pacific sharpnose shark",
#     scientific_name == "Dwarf gulper shark" ~ "Dwarf gulper shark",
#     scientific_name == "Tiger catshark" ~ "Tiger catshark",
#     scientific_name == "Gulper shark" ~ "Gulper shark",
#     scientific_name == "Leafscale gulper shark" ~ "Leafscale gulper shark",
#     scientific_name == "Bonnethead" ~ "Bonnethead",
#     scientific_name == "Blackspotted catshark" ~ "Blackspotted catshark",
#     scientific_name == "Dusky shark" ~ "Dusky shark",
#     scientific_name == "Shortfin mako" ~ "Shortfin mako",
#     scientific_name == "Banded houndshark" ~ "Banded houndshark",
#     scientific_name == "Japanese shortnose spurdog" ~ "Japanese shortnose spurdog",
#     scientific_name == "Whitecheek shark" ~ "Whitecheek shark",
#     scientific_name == "Oceanic whitetip shark" ~ "Oceanic whitetip shark",
#     TRUE ~ ""
#   ))
...
prop = 
  ...
  annotate("text",
             ...
             y = v -5, label = paste0(head(v), "%"), color = "grey", size = 32, angle = 0, fontface = "bold", hjust = 0.7) +
    geom_col(aes(x = id, 
               y = percent_diff, 
  ...
  geom_text(data = label_data_m, 
            aes(x = id, y = percent_diff + 50, label = scientific_name, angle = angle),
            nudge_x = -0.25, nudge_y = 0.25,
              color = "black", size = 25, inherit.aes = FALSE) +
  geom_segment(data = redlist_breaks,
  ...
  geom_text(data = redlist_breaks,
            ...
            show.legend = F,
            hjust = 1, alpha = 0.8, size = 42, fontface = "bold", inherit.aes = FALSE) +
...
ggsave(prop, file = paste0("fig4.pdf"), path = here::here("figs", "poster"), height = 70, width = 70, limitsize = FALSE)
```
